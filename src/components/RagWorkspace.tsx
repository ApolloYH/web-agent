...
const PIPELINES: Record<RagPipelineTemplate, PipelineDefinition> = {
  custom: { label: '自定义模式', category: '自定义', description: '从最小画布开始，自行添加、连接并配置数据处理节点。', method: 'general', nodes: [node('source', '数据源', '输入', '接收待处理文档。'), node('index', '知识索引', '输出', '写入可检索知识库。')] },
